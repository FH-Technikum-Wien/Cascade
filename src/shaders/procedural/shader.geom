...
// Lookup table for all mc-cases (each case is 12 entries long)
// Cases with less than 4 triangles will draw triangles with no size -> No if's needed
int mcCases[3072] = {
...
void main()
{
    ...
    for(int i = 0; i < 12; i += 3)
    {
        ...
        // One marching-cube-case completed
        EndPrimitive();
    }
}